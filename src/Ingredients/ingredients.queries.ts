export const ingredientQueries = {
    ...
    */
    ...
    readIngredients: `SELECT id AS ingredientId, name AS name FROM ingredients;`,
    readIngredientByName: `SELECT id AS ingredientId, name AS name FROM ingredients WHERE name = ?;`,
    readIngredientByNameSearch: `SELECT id AS ingredientId, name AS name FROM ingredients WHERE name LIKE ?;`,
    readIngredientNameById: `SELECT name AS name FROM ingredients WHERE id = ?`,
    updateIngredient: `UPDATE ingredients SET name = ? WHERE id = ?;`,
